...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6106798264:AAGDT9UI8Egk37o1xDPR0yANp3Q4VeSgLws")
    # There is no measure to limit who can use this bot, so add userids of users authorized to use this bot
    AUTH_USERS = os.environ.get("AUTH_USERS", "2126570077")
    ...
    GOD_USERS = os.environ.get("GOD_USERS", "2126570077")
